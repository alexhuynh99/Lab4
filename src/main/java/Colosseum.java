...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        while (attack <= 0 || attack > MAX_HIT_POINTS - 1) {
            System.out.println("Sorry. The attack level must be between 1 and 49: ");
            attack = myScan.nextInt();
        }
        tempPokemon.attackLevel = attack;

        int leftoverPoints = MAX_HIT_POINTS - attack;
        System.out.println("Enter your defense level (1-" + leftoverPoints + "): ");
        int defense = myScan.nextInt();
        while (defense <= 0 || defense > leftoverPoints) {
            System.out.println("Sorry. The defense level must be between 1 and " + leftoverPoints + ": ");
